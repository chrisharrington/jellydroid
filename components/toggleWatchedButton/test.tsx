...
describe('ToggleWatchedButton', () => {
    ...
    it('renders correctly with check circle icon', () => {
        const { getByTestId } = render(
            <TestWrapper>
                <ToggleWatchedButton item={mockItem} />
            </TestWrapper>
        );
    ...
    it('calls toggleItemWatched with correct parameters', async () => {
        const { getByTestId } = render(
            <TestWrapper>
                <ToggleWatchedButton item={mockItem} onToggleComplete={mockOnToggleComplete} />
            </TestWrapper>
        );
    ...
    it('calls toggleItemWatched with watched=true when item has playback progress', async () => {
        ...
        const { getByTestId } = render(
            <TestWrapper>
                <ToggleWatchedButton item={itemWithProgress} onToggleComplete={mockOnToggleComplete} />
            </TestWrapper>
        );
    ...
    it('does not trigger toggle when item is null', async () => {
        const { getByTestId } = render(
            <TestWrapper>
                <ToggleWatchedButton item={null as any} />
            </TestWrapper>
        );
